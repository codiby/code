...
type IndexEntry = { name: string; path: string; rel: string; type: 'file' | 'dir' };
const fileIndexCache = new Map<string, { files: IndexEntry[]; ts: number }>();
const FILE_INDEX_TTL = 30_000; // 30s cache

function buildFileIndex(root: string): IndexEntry[] {
